...
/* harmony import */ var lib_resolve_notion_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6814);
/* harmony import */ var components__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(339);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([lib_config__WEBPACK_IMPORTED_MODULE_2__, lib_get_site_map__WEBPACK_IMPORTED_MODULE_3__, lib_resolve_notion_page__WEBPACK_IMPORTED_MODULE_4__, components__WEBPACK_IMPORTED_MODULE_5__]);
([lib_config__WEBPACK_IMPORTED_MODULE_2__, lib_get_site_map__WEBPACK_IMPORTED_MODULE_3__, lib_resolve_notion_page__WEBPACK_IMPORTED_MODULE_4__, components__WEBPACK_IMPORTED_MODULE_5__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const getStaticProps = async (context)=>{
    ...
    try {
        const props = await (0,lib_resolve_notion_page__WEBPACK_IMPORTED_MODULE_4__/* .resolveNotionPage */ .g)(lib_config__WEBPACK_IMPORTED_MODULE_2__/* .domain */ .nw, rawPageId);
        return {
            props,
            revalidate: 10
        };
    } catch (err) {
        console.error("page error", lib_config__WEBPACK_IMPORTED_MODULE_2__/* .domain */ .nw, rawPageId, err);
...
async function getStaticPaths() {
    if (lib_config__WEBPACK_IMPORTED_MODULE_2__/* .isDev */ .r8) {
        return {
            paths: [],
            fallback: true
        };
...
function NotionDomainDynamicPage(props) {
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(components__WEBPACK_IMPORTED_MODULE_5__/* .NotionPage */ .mK, {
        ...props
    });
};
...
var __webpack_exports__ = __webpack_require__.X(0, [952,157,872,595,339,655,814], () => (__webpack_exec__(7199)));
