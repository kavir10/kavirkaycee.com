...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([lib_config__WEBPACK_IMPORTED_MODULE_0__]);
lib_config__WEBPACK_IMPORTED_MODULE_0__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
Sitemap: ${lib_config__WEBPACK_IMPORTED_MODULE_0__/* .host */ .ho}/sitemap.xml
`);
    } else {
        res.write(`User-agent: *
Disallow: /
